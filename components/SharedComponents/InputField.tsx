  ...
  return (
    <div className="flex flex-col justify-start items-start w-full gap-1">
      ...
      <div className="relative w-full">
        {isPhoneInput ? (
          <div className="flex flex-row-reverse border border-borderColor rounded-lg">
            <PhoneInput
          ...
          <>
            <input
              ...
              {...register}
              {...rest}
              className="border border-borderColor h-[36px] rounded-lg focus:outline-none placeholder:text-[#525252] w-full py-2 ps-2"
            />
            {type === "password" && (
              <button
                type="button"
